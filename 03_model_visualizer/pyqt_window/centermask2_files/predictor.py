...
class VisualizationDemo(object):
    def __init__(self, cfg, my_args, instance_mode=ColorMode.IMAGE, parallel=False):
        """
        Args:
            cfg (CfgNode):
    ...
    def run_on_video(self, video):
        ...
        def process_predictions(frame, predictions):
            ...
            if "panoptic_seg" in predictions:
                ...
                vis_frame = video_visualizer.draw_instance_predictions(frame, predictions, show_boxes=self.args.show_boxes, show_labels=self.args.show_labels, set_alpha=self.args.set_alpha)
