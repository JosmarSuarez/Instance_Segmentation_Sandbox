...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rb_webcam = QtWidgets.QRadioButton(self.centralwidget)
        self.rb_webcam.setChecked(True)
        self.rb_webcam.setObjectName("rb_webcam")
        self.verticalLayout_5.addWidget(self.rb_webcam)
        ...
        self.webcam_id = QtWidgets.QSpinBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.webcam_id.sizePolicy().hasHeightForWidth())
        self.webcam_id.setSizePolicy(sizePolicy)
        self.webcam_id.setProperty("value", 1)
        self.webcam_id.setObjectName("webcam_id")
        self.horizontalLayout_2.addWidget(self.webcam_id)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.resBox.sizePolicy().hasHeightForWidth())
        self.resBox.setSizePolicy(sizePolicy)
        self.resBox.setObjectName("resBox")
        self.horizontalLayout.addWidget(self.resBox)
        self.verticalLayout_5.addLayout(self.horizontalLayout)
        self.rb_file = QtWidgets.QRadioButton(self.centralwidget)
        self.rb_file.setObjectName("rb_file")
        self.verticalLayout_5.addWidget(self.rb_file)
        ...
        self.verticalLayout_5.addWidget(self.line_in)
        ...
        self.line_out = QtWidgets.QLineEdit(self.centralwidget)
        self.line_out.setObjectName("line_out")
        self.verticalLayout_5.addWidget(self.line_out)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        self.verticalLayout_5.addItem(spacerItem2)
        self.configuration.addLayout(self.verticalLayout_5)
        spacerItem3 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.configuration.addItem(spacerItem3)
        ...
        self.verticalLayout_3.addWidget(self.startButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.verticalLayout_3.addWidget(self.stopButton, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rb_webcam.setText(_translate("MainWindow", "Desde webcam"))
        self.label_3.setText(_translate("MainWindow", "Dispositivo de video:"))
        self.label_4.setText(_translate("MainWindow", "Resolución:"))
        self.rb_file.setText(_translate("MainWindow", "Desde archivo"))
        self.openButton.setText(_translate("MainWindow", "Abrir archivo:"))
